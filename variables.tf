...
variable "aft_framework_repo_url" {
  ...
  #default = "https://github.com/djivan1990/terraform-aws-control_tower_account_factory.git"
  default = "git@github.com:djivan1990/terraform-aws-control_tower_account_factory.git"
  type    = string
  validation {
